function userAttributesTemplate(locals) {
var buf = [];
var jade_mixins = {};
var jade_interp;
...
buf.push("<div class=\"cellular\"><a" + (jade.attr("href", "#user-attribute-" + (entity.guid) + "", true, false)) + ">" + (jade.escape(null == (jade_interp = entity.name) ? "" : jade_interp)) + "</a><a" + (jade.attr("href", "#edit-user-attribute-" + (entity.guid) + "", true, false)) + ">Edit</a></div>");
    }
