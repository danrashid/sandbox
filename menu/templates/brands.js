function brandsTemplate(locals) {
var buf = [];
var jade_mixins = {};
var jade_interp;
...
buf.push("<div class=\"cellular\"><a" + (jade.attr("href", "#brand-" + (entity.guid) + "", true, false)) + ">" + (jade.escape(null == (jade_interp = entity.name) ? "" : jade_interp)) + "</a><a" + (jade.attr("href", "#edit-brand-" + (entity.guid) + "", true, false)) + ">Edit</a></div>");
    }
